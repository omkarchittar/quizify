...
class QuizGenerator:
    ...
    def init_llm(self):
        ...
        self.llm = VertexAI(
            ############# YOUR CODE HERE ############   
            # Set the model name to "gemini-pro"
            model_name="gemini-pro",
            # Set the temperature parameter to control randomness
            temperature=0.8,
            # Set the maximum output tokens to limit the length of generated text

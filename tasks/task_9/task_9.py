...
class QuizManager:
    ...
    def __init__(self, questions: list):
        ...
        """
        ##### YOUR CODE HERE #####
        # Store the provided list of quiz question objects in an instance variable named `questions`
        self.questions = questions
        # Calculate and store the total number of questions in the list in an instance variable named `total_questions`
    ...
    def next_question_index(self, direction=1):
        ...
        # Adjust the index based on the provided `direction` (1 for next, -1 for previous)
...
if __name__ == "__main__":
    ...
    if question_bank:
        ...
        with st.container():
            ...
            # Task 9
            ##########################################################
            # Use our new QuizManager class to manage the quiz questions
            quiz_manager = QuizManager(question_bank)
            # Format the question and display it on Streamlit

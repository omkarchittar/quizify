    ...
    def ingest_documents(self):
        ...
        if uploaded_files is not None:
            for uploaded_file in uploaded_files:
                ...
                loader = PyPDFLoader(temp_file_path) # Initialize the PyPDFLoader with the temporary file path
                pages = loader.load_and_split() # Load and split the PDF file into pages
                
                # Step 3: Then, Add the extracted pages to the 'pages' list.
                #####################################
                self.pages.extend(pages)    # Add the extracted pages to the 'pages' list
